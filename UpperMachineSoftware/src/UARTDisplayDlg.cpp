...
CUARTDisplayDlg::CUARTDisplayDlg(CWnd* pParent /*=nullptr*/)
...
void Check(CUARTDisplayDlg* dlg)
{
	dlg->CheckVer();
}
...
void CUARTDisplayDlg::CheckVer()
{
	...
	{
		rofirger::add_log(rofirger::LOG_LEVEL_ERROR, "file {%ls} doesn't can be accessed", str_file_name_ini);
	...
	if (!PathIsDirectory(strFolderPath))
	{
		...
		rofirger::add_log(rofirger::LOG_LEVEL_WARNING, "create new folder{%ls}. That means this computer is missing VerInfo.ini!", strFolderPath.GetBuffer());
...
void CUARTDisplayDlg::OnDropFiles(HDROP hDropInfo)
{
...
void CUARTDisplayDlg::DownloadFile(CString szUrl, CString szPath)
{
	CBindCallback cbc;
...
void CUARTDisplayDlg::FindExePath()
{
